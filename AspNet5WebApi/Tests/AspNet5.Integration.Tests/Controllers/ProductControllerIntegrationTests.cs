...
using AspNet5.Integration.Tests.Infrastructure;


namespace AspNet5.Integration.Tests.Controllers
{
    public class ProductControllerIntegrationTests : BaseControllerTest
    {
