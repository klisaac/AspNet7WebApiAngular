...
{
    public class AspNet5DataContext : DbContext
    {
        private IDbContextTransaction _currentTransaction;
        //private IConfiguration _configuration;
        //private readonly ICurrentUser _currentUser;

        public AspNet5DataContext()
        {
        ...
        //}
        public AspNet5DataContext(DbContextOptions<AspNet5DataContext> options)
            : base(options)
        {
            ChangeTracker.LazyLoadingEnabled = false;
        }
        ...
        {
            modelBuilder.Entity<Address>(AspNet5ModelBuilder.ConfigureAddress);
            modelBuilder.Entity<Category>(AspNet5ModelBuilder.ConfigureCategory);
            modelBuilder.Entity<Product>(AspNet5ModelBuilder.ConfigureProduct);
            modelBuilder.Entity<Customer>(AspNet5ModelBuilder.ConfigureCustomer);
            modelBuilder.Entity<Order>(AspNet5ModelBuilder.ConfigureOrder);
            modelBuilder.Entity<OrderItem>(AspNet5ModelBuilder.ConfigureOrderItem);
            modelBuilder.Entity<Payment>(AspNet5ModelBuilder.ConfigurePayment);
            modelBuilder.Entity<User>(AspNet5ModelBuilder.ConfigureUser);
