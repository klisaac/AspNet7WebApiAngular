...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'customer-detail/:customerId', component: CustomerDetailComponent, data: { title: 'Detail' } },
      { path: 'customer-edit', component: CustomerEditComponent, data: { title: 'New' } },
      { path: 'customer-edit/:customerId', component: CustomerEditComponent, data: { title: 'Edit' } },
      { path: 'customer-order', component: CustomerOrderComponent, data: { title: 'New' } },
      { path: 'customer-order/:customerId', component: CustomerOrderComponent, data: { title: 'Orders' } },
    ]
  }
];
